...
@torch.no_grad()
def get_frustum_mask(points: torch.Tensor, cameras: List[Camera], near: float = 0.02, far: float = 1e6): # NOT USED
...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int):
        ...
        std = 1e-4
        self._appearance_embeddings = nn.Parameter(torch.empty(3192, 64).cuda())
